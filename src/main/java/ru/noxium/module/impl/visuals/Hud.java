...
public class Hud extends Module {
         ...
         for (int i = this.notifications.size() - 1; i >= 0; i--) {
            ...
            if (!(animValue <= 0.01F)) {
               ...
               matrix.rect(
                     ...
                     11.22F,
                     4.0F,
                     ColorUtil.replAlpha(0xA0D8FF, animValue * 0.2F));
               ...
               matrix.text(
                     ...
                     26.0F,
                     notification.text,
                     ColorUtil.replAlpha(0xA0D8FF, animValue));
               matrix.popTransform();
               matrix.popClipRect();
               matrix.popRotation();
               matrix.popScale();
   ...
   public static void drawClientRect(Renderer2D r2, float x, float y, float w, float h, float radius, float alpha,
      ...
      int bgColor = Renderer2D.ColorUtil.rgba(18, 18, 18, (int)(80.0F * alpha));
      int outlineColor = Renderer2D.ColorUtil.rgba(33, 33, 33, (int)(255.0F * alpha));
      
      r2.rect(x, y, w, h, radius, bgColor);
      r2.rectOutline(x, y, w, h, radius, outlineColor, 2.0F);
   }
