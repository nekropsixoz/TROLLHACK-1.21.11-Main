package ru.noxium.commands.suggestions;

import java.util.ArrayList;
import java.util.List;
import net.fabricmc.api.EnvType;
import net.fabricmc.api.Environment;
import ru.noxium.config.ConfigCommandSuggestions;
import ru.noxium.commands.macros.MacrosCommandSuggestions;
import ru.noxium.config.friend.FriendCommandSuggestions;
...
public final class CommandSuggestionManager {
   private static final List<CommandSuggestionProvider> PROVIDERS = List.of(
         ...
         MacrosCommandSuggestions.getInstance(),
