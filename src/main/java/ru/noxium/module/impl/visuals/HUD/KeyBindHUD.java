...
public class KeyBindHUD {
   ...
   public static void keybind(Renderer2D r2) {
      ...
      if (!closeCondition || anim2.get() != 0.0F) {
         ...
         r2.text(FontRegistry.ICONS, x + 14.0F, y + 30.0F, 36.0F, "x", ColorUtil.replAlpha(0xA0D8FF, anim2.get()));
         r2.shadow(
            x + 21.0F,
            y + 20.0F,
            0.3F,
            ...
            7.5F,
            0.5F,
            Renderer2D.ColorUtil.replAlpha(0xA0D8FF, (int)(75.0F * anim2.get()))
         );
         r2.rect(x + 40.0F, y + 15.5F, 2.0F, 11.0F, Renderer2D.ColorUtil.replAlpha(0xA0D8FF, (int)(51.0F * anim2.get())));
         r2.text(FontRegistry.INTER_MEDIUM, x + 52.0F, y + 26.0F, 28.0F, "Binds", ColorUtil.replAlpha(0xA0D8FF, anim2.get()));
         r2.rect(x, y + 39.52F, animatedWidth, 1.0F, Renderer2D.ColorUtil.replAlpha(0xA0D8FF, (int)(25.0F * anim2.get())));
         if (expand) {
            float offset = 0.0F;
            ...
            for (Module modulex : bindings) {
               ...
               if (animPC > 0.0F) {
                  ...
                  float keyNameWidth = r2.measureText(FontRegistry.INTER_MEDIUM, keyName, 28.0F).width;
                  int textColor = Renderer2D.ColorUtil.replAlpha(0xA0D8FF, (int)(animPC * 255.0F));
                  int mainColor = Renderer2D.ColorUtil.replAlpha(0xA0D8FF, (int)(animPC * 255.0F));
