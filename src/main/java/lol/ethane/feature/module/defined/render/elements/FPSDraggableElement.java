...
public class FPSDraggableElement extends DraggableComponent {
   private float outlineAlpha;

   public FPSDraggableElement() {
      super("FPS", 10.0F, 10.0F, 50.0F, 15.0F, 4.0F);
   }
   ...
   protected void onRender(MgfxContext context, class_332 graphics, float x, float y, float w, float h) {
      ...
      String value = " " + class_310.method_1551().method_47599();
